document.addEventListener('DOMContentLoaded', function() {
    ...
    // Efecto de animación en el icono de editorial
    const editorialIcon = document.querySelector('.editorial-icon');
    if (editorialIcon) {
        editorialIcon.addEventListener('mouseenter', function() {
            this.style.transform = 'scale(1.1) rotate(5deg)';
            this.style.color = '#20c997';
        });
        
        editorialIcon.addEventListener('mouseleave', function() {
